...
void debugDrawRectOutline(RectF rect, Colour colour, bool translateToCameraCoords)
{
	SDL_SetRenderDrawColor(Renderer::Get()->sdlRenderer(), colour.r, colour.g, colour.b, colour.a);
...
void debugRenderText(const BasicString text, int ptSize, VectorF position, Colour colour, const char* alignment)
{
